...
$query = "SELECT fname, lname, mi, suffix, birthdate, age, sex, contact, address, profile_pic, email FROM admin WHERE id = ?";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['firstName'])) {
  ...
  // Update query
  $updateQuery = "UPDATE admin SET fname = ?, lname = ?, mi = ?, suffix = ?, contact = ?, address = ?, birthdate = ?, age = ?, sex = ?, profile_pic = ? WHERE id = ?";
