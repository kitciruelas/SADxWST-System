...
<head>
    ...
    <link rel="stylesheet" href="../Admin/Css_Admin/admin-announce.css">
...
<button class="back-button" onclick="location.href='user-dashboard.php'"><i class="fas fa-arrow-left fa-2x"></i></button>
