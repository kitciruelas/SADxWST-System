...
if (isset($_POST['received_msg'])) {
    ...
    if ($stmt) {
        ...
        echo json_encode(["error" => "Received message insertion failed"]);
    }
    exit;
}
...
function submitchat() {
    ...
    $.ajax({
        type: "POST",
        url: "chat.php",  // Specify the correct endpoint for sending messages
        data: { msg: msg },
...
function deleteMessage(messageId) {
    if (confirm("Are you sure you want to delete this message?")) {
        $.ajax({
            type: "POST",
            url: "chat.php",  // Specify the correct endpoint for deleting messages
